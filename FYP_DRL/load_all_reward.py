...
scio.savemat("data_20_5&11/obj1_%d_%d.mat"%(STATIC_SIZE, D), {'obj1':obj1_matrix})
scio.savemat("data_20_5&11/obj2_%d_%d.mat"%(STATIC_SIZE, D), {'obj2':obj2_matrix})
scio.savemat("data_20_5&11/rl%d_%d.mat"%(STATIC_SIZE, D),{'rl':objs})
scio.savemat("data_20_5&11/tour%d_%d.mat"%(STATIC_SIZE, D),{'tour':np.array(tours)})
