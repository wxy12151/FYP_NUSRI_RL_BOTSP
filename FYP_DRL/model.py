...
class DRL4TSP(nn.Module):
    ...
    def forward(self, static, dynamic, decoder_input=None, last_hh=None):
        ...
        now_1 = now_2 = now_3 = now_4 = 999
        for _ in range(max_steps):
            # print(_) #从0递增到城市数量10


            city1_1 = 5 #city for constraint 1.Precedence Constraints 
            city2_1 = 2
            city1_2 = 5 #city for constraint 2.Blockage between two cities
            city2_2 = 2
            city1_3 = 17 #city for constraint 3.Visit two cities consecutively
            city2_3 = 12
            city_start = 0
            ...
            # 1.Precedence Constraints 去过城市2后再去城市1
            # if (mask[:,city1_1] and mask[:,city2_1]):
            #     mask[:,city1_1] = 0 #城市1不能在城市2之前经过
            # elif (mask[:,city2_1] == 0 and mask_last[:,city2_1] == 1): #刚去过城市2
            #     # print('恢复城市1的权限')
            #     mask[:,city1_1] = 1 #恢复城市1的权限
            # print(mask)
            
            # 2.Blockage between two cities 城市1和城市2之间不允许通行
            # D = 20
            # if _ != D-1:
            #     if ((mask_last[:,city1_2] , mask_last[:,city2_2]) == (1 , 1) and mask[:,city1_2] == 0): #刚去过城市1
            #         mask[:,city2_2] = 0
            #         now_1 = _
            #     elif ((mask_last[:,city1_2] , mask_last[:,city2_2]) == (1 , 1) and mask[:,city2_2] == 0): #刚去过城市2
            #         mask[:,city1_2] = 0
            #         now_2 = _
            # if _ == now_1 + 1:
            #         mask[:,city2_2] = 1    
            ...
            #3.Visit two cities consecutively 城市1和城市2必须相连,下面还有两行
            # if (mask[:,city1_3] == 0 and mask_last[:,city1_3] == 1): #刚去过城市1
            #     now_3 = _
            # if (mask[:,city2_3] == 0 and mask_last[:,city2_3] == 1): #刚去过城市2
            #     now_4 = _
            ...
            # # 3.Visit two cities consecutively(continue)
            # if _ == now_3:#刚去过城市1
            #     probs[:,city2_3] = 100
            # elif _ == now_4:#刚去过城市2
            #     probs[:,city1_3] = 100

            # combine 1 & 3, city2 right before city 1
            # if _ == now_2:
            #     probs[:,city1_3] = 100
